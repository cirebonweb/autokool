...
class BuatSpInvoiceIsi extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'invoice_sp_id' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true],
        ...
        $this->forge->addForeignKey('invoice_sp_id', 'sp_invoice_sp', 'id', 'NO ACTION', 'CASCADE');
        $this->forge->createTable('sp_invoice_isi');
    }

    public function down()
    {
        $this->forge->dropTable('sp_invoice_isi');
    }
}
